...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    setTimeout(() => {
      alert('Form is valid and would be submitted (mock).');
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-200 via-pink-100 to-yellow-100 p-6">
      <div className="w-full max-w-xl bg-pink-350/90 p-8 rounded-2xl shadow-xl space-y-6 transition-transform duration-300 ease-in-out hover:scale-[1.01]">
